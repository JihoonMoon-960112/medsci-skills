...
| **self-review** | Pre-submission self-review from reviewer perspective. Systematic check across 7 categories (study design, reference standard, statistics, clinical framing, reproducibility, reporting, guidelines). |
